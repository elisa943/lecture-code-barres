...
gauss_x_prime=G_x_prime(filter_size,sigma_t)
gauss_y_prime=G_y_prime(filter_size,sigma_t)
#gradient
...
Txx=signal.convolve2d(In_x*In_x,gauss2D,mode='same', boundary='fill', fillvalue=0)
Tyy=signal.convolve2d(In_y*In_y,gauss2D,mode='same', boundary='fill', fillvalue=0)
Txy=signal.convolve2d(In_x*In_y,gauss2D,mode='same', boundary='fill', fillvalue=0)
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~ Affichage ~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
#%%
plot_channels([img_code_barre,D_res,D_seuil],["image originale","mesure de cohérence","image seuilée"],res_factor=2)
